...
1. **Unistate CKB Testnet Endpoint**:
   - **URL**: [https://unistate-ckb-test.unistate.io/v1/graphql](https://unistate-ckb-test.unistate.io/v1/graphql)
   - **Usage**: Suitable for testing and development on the CKB test network.

2. **CKB Graph Mainnet Endpoint**:
   - **URL**: [https://ckb-graph.unistate.io/v1/graphql](https://ckb-graph.unistate.io/v1/graphql)
   - **Usage**: Appropriate for production applications interacting with the mainnet CKB network.
